...
.back {
    ...
    >
        ...
        >
            <div class="relative w-full overflow-hidden">
                ...
                <!-- Product Image -->
                <a
                    :href="product.is_saleable ? `{{ route('shop.product_or_category.index', '') }}/${product.url_key}` : '#'"
                    ...
                    <div class="flipper justify-center absolute inset-0">
                        ...
                        <div class="back absolute inset-0">
                            ...
                            ::srcset="`
                                ...
                                ${product.images[1]?.medium_image_url ?? product.base_image.medium_image_url} 300w,
                            `"
                            sizes="(max-width: 768px) 150px, (max-width: 1200px) 300px, 600px"
                            ::key="product.id"
                            ::index="product.id"
            ...
            <div class="flex flex-col justify-between border-t border-gray-200 bg-white p-3 gap-2">
                ...
                <div class="action-items flex items-center justify-between transition-all duration-300 ease-in-out max-md:hidden">
                    @if (core()->getConfigData('sales.checkout.shopping_cart.cart_page'))
                        ...
                        <button
                            class="secondary-button w-full max-w-full p-2.5 max-sm:rounded-xl max-sm:p-2"
    ...
    <script type="module">
        app.component('v-product-card', {
            ...
            props: ['mode', 'product', 'attribute_family_id'],
