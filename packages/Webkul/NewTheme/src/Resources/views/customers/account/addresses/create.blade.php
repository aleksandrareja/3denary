        ...
        >
            <div>
                <x-shop::form :action="route('shop.customers.account.addresses.store')">
                    ...
                    <button
                        type="submit"
                        class="primary-button m-0 block rounded-lg px-11 py-3 text-center text-base max-md:w-full max-md:max-w-full max-md:rounded-lg max-md:py-2 max-sm:py-1.5"
                    >
