...
@pushOnce('scripts')
    ...
    >
        ...
        <!-- Filters Container -->
        <template v-else>
            <div class="panel-side journal-scroll grid max-h-[1320px] grid-cols-[1fr] overflow-y-auto overflow-x-hidden max-xl:min-w-[270px] md:max-w-[342px] md:ltr:pr-7 md:rtl:pl-7">
                ...
                <template v-else>
                    ...
                    <ul class="pb-3 text-base text-gray-700">
                        <template v-if="options.length">
                            ...
                            >
                                <label
                                    class="flex items-center cursor-pointer gap-2 p-2 hover:bg-gray-100"
                                >
                                    <input
                                    type="checkbox"
