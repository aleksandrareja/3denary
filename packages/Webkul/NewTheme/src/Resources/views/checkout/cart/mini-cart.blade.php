                ...
                >
                    ...
                    >
                        ...
                        <a
                            ...
                            class="mx-auto block w-full cursor-pointer rounded-lg bg-navyBlue px-11 py-4 text-center text-base font-medium text-white max-md:rounded-lg max-md:px-5 max-md:py-2"
                        >
