<div class="w-[418px] max-w-full max-md:w-full">
    ...
    <div class="mt-6 grid gap-4 max-md:mt-2 max-md:gap-2.5">
        ...
        <a
            ...
            class="primary-button mt-4 place-self-end rounded-lg px-11 py-3 max-md:my-4 max-md:max-w-full max-md:rounded-lg max-md:py-3 max-md:text-sm max-sm:w-full max-sm:py-2"
        >
