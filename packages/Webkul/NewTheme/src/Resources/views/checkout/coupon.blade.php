                ...
                >
                    ...
                    <form @submit="handleSubmit($event, applyCoupon)">
                        ...
                        <x-shop::modal ref="couponModel">
                            ...
                            <x-slot:toggle>
                                <span 
                                    class="cursor-pointer text-base text-goldenOrange max-sm:text-sm"
                                    role="button"
                                    tabindex="0"
                            ...
                            <x-slot:footer>
                                ...
                                <div class="flex flex-wrap items-center gap-4 max-md:justify-between">
                                    ...
                                    <x-shop::button
                                        class="primary-button max-w-none flex-auto rounded-lg px-11 py-3 max-md:max-w-[153px] max-md:rounded-lg max-md:py-2"
