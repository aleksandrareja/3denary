...
<div class="sticky top-20 flex flex-wrap justify-center h-max gap-8 max-md:hidden self-start">
    ...
    <div class="flex w-full justify-center gap-2.5 overflow-y-auto overflow-x-hidden">
        <!-- Arrow Up -->
        <span
        ...
        <div
            ref="swiperContainer"
            class="flex gap-2.5 [&>*]:flex-[0] overflow-auto scroll-smooth scrollbar-hide"
        >
