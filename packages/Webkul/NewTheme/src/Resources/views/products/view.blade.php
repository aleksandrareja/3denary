                               ...
                               <div class="mt-8 mb-8 space-y-6">
                                    <div class="flex items-center gap-4 group">
                                        ...
                                        <div class="flex flex-col">
                                            <p class="text-sm uppercase tracking-[2px] font-semibold text-zinc-500">Bezpieczny zakup</p>
                                            <p class="text-sm text-zinc-400 font-light leading-snug mt-0.5">Gwarancja autentyczności i bezpieczne płatności online.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center gap-4 group">
                                        ...
                                        <div class="flex flex-col">
                                            <p class="text-sm uppercase tracking-[2px] font-semibold text-zinc-500">Zakup telefoniczny</p>
                                            <p class="text-sm text-zinc-400 font-light leading-snug mt-0.5">Doradztwo numizmatyczne i zamówienia przez telefon.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center gap-4 group">
                                        ...
                                        <div class="flex flex-col">
                                            <p class="text-sm uppercase tracking-[2px] font-semibold text-zinc-500">Ubezpieczona wysyłka</p>
                                            <p class="text-sm text-zinc-400 font-light leading-snug mt-0.5">Paczki ubezpieczone na pełną wartość przedmiotu.</p>
                                        </div>
                                    </div>
