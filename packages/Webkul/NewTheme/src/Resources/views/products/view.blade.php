                    ...
                    <div class="container px-[60px] max-1180:px-0">
                        <div class="mt-12 flex max-1180:flex-wrap gap-12 max-lg:mt-0 max-sm:gap-y-6">
                            ...
                            <div class="flex flex-col gap-6">
                               ...
                               <div class="mt-8 mb-8 space-y-6 gap-y-2">
                                    <div class="flex items-center gap-4 group">
                                        ...
                                        <div class="flex flex-col">
                                            <p class="text-sm uppercase tracking-[2px] font-semibold text-zinc-700">Bezpieczny zakup</p>
                                    ...
                                    <div class="flex items-center gap-4 group">
                                        ...
                                        <div class="flex flex-col">
                                            <p class="text-sm uppercase tracking-[2px] font-semibold text-zinc-700">Zakup telefoniczny</p>
                                    ...
                                    <div class="flex items-center gap-4 group">
                                        ...
                                        <div class="flex flex-col">
                                            <p class="text-sm uppercase tracking-[2px] font-semibold text-zinc-700">Ubezpieczona wysyłka</p>
